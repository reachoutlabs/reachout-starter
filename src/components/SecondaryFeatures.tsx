...
export default function SecondaryFeatures() {
  return (
    <div className="my-32 overflow-hidden bg-white">
          ...
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                ReachOut is the integrated backend for marketing and content web
                applications, triggered emails, newsletters, web analytics,
                automations and data management.
              </p>
