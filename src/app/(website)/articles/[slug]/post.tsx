  ...
  return (
    <div className="bg-white pt-64">
      ...
      <div className="w-full">
        <Image
          src={`https://reachout-demo.reachoutapp.io/assets/${post?.articleFeaturedImage.id}`}
          alt={post?.headline || ""}
          width={1600}
          height={1200}
      ...
      <div className="mt-10 max-w-3xl mx-auto text-lg prose font-medium leading-7 dark:prose-invert [&>p]:text-regular [&>p]:mt-4">
