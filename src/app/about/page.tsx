    ...
    <div className="bg-slate-200">
        ...
        <div className="px-6 pt-14 lg:px-8">
          <div className="mx-auto max-w-2xl pt-24 text-center sm:pt-40">
            <h2 className="text-4xl font-bold tracking-tight text-slate-600 sm:text-6xl">We love creators</h2>
            ...
            <dl className="mt-16 grid grid-cols-1 gap-x-8 gap-y-12 sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mt-28 lg:grid-cols-4">
              {stats.map((stat, statIdx) => (
                <div key={statIdx} className="flex flex-col-reverse gap-y-3 border-l border-white/20 pl-6">
                  ...
                  <dd className="text-3xl font-semibold tracking-tight text-slate-600">{stat.value}</dd>
                </div>
              ))}
            </dl>
          </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-3xl font-bold tracking-tight text-slate-600 sm:text-4xl">Our values</h2>
            <p className="mt-6 text-lg leading-8 text-slate-500">
            ...
            {values.map((value) => (
              <div key={value.name} className="relative pl-9">
                <dt className="inline font-semibold text-slate-600">
                  <value.icon className="absolute left-1 top-1 h-5 w-5 text-purple-500" aria-hidden="true" />
                  {value.name}
                </dt>{' '}
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-3xl font-bold tracking-tight text-slate-600 sm:text-4xl">Our team</h2>
            <p className="mt-6 text-lg leading-8 text-slate-500">
          ...
          >
            {team.map((person) => (
              <li key={person.name}>
                ...
                <h3 className="mt-6 text-lg font-semibold leading-8 tracking-tight text-slate-600">{person.name}</h3>
                <p className="text-base leading-7 text-slate-500">{person.role}</p>
          ...
          <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="mx-auto flex max-w-2xl flex-col gap-16 bg-white/5 px-6 py-16 ring-1 ring-white/10 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20">
              ...
              <div className="w-full flex-auto">
                <h2 className="text-3xl font-bold tracking-tight text-slate-600 sm:text-4xl">Join our team</h2>
                <p className="mt-6 text-lg leading-8 text-slate-500">
                ...
                <ul
                  role="list"
                  className="mt-10 grid grid-cols-1 gap-x-8 gap-y-3 text-base leading-7 text-slate-600 sm:grid-cols-2"
                >
